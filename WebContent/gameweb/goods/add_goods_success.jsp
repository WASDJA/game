...
<html>
  <head>
    ...
    <title>My JSP 'add_goods_success.jsp' starting page</title>
  ...
  <body>
    <div id="formwrapper">
			<h3 style="text-align: center;">添加商品成功</h3>
			<div class="enter">
				<input name="addGood" type="button" class="buttom" value="继续添加商品" onclick="window.location = 'goods/add_goods.jsp'" />
