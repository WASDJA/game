...
$(function() {
	...
	$("a[class='btn btn-default']").click(function(event) {
		...
		flyer.fly({
			...
			onEnd: function() {
				//console.log(offset.left + 10+"       "+offset.top + 10)
				$("#msg").show().animate({ width: '250px' }, 200).fadeOut(2000);
				this.destory();
			}
		});
	});
