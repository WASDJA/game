...
<html>
  ...
  <body>
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
					...
					<form action="SearchUserServlet" method="get">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td width="160px"><input type="text" name="title" value="${param.username }"></td>
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
						<tr>
							...
							<td width="50" height="20" bgcolor="d3eaef" class="STYLE6">
								<div align="center"><span class="STYLE10">用户密码</span></div>
							</td>
							<td width="50" height="20" bgcolor="d3eaef" class="STYLE6">
								<div align="center"><span class="STYLE10">用户手机</span></div>
							</td>
							<td width="50" height="20" bgcolor="d3eaef" class="STYLE6">
								<div align="center"><span class="STYLE10">邮箱账户</span></div>
							</td>
							<td width="70" height="20" bgcolor="d3eaef" class="STYLE6">
								<div align="center"><span class="STYLE10">激活状态</span></div>
							</td>
						</tr>
							...
							<c:forEach items="${users}" var="u">
								<tr>
									<td height="20" bgcolor="#FFFFFF">
										<div align="center">
											<input type="checkbox" name="id" value="${u.username}" />
										</div>
									</td>
									<td height="20" bgcolor="#FFFFFF" class="STYLE19">
										<div align="center">
											<a href="OpenUpdateUserServlet?username=${u.username}" title="点击查看和编辑用户">${u.username}</a>
										</div>
									</td>
									<td height="20" bgcolor="#FFFFFF" class="STYLE19">
										<div align="center">${u.password }</div>
									</td>
									<td height="20" bgcolor="#FFFFFF" class="STYLE19">
										<div align="center">${u.phone }</div>
									</td>
									<td height="20" bgcolor="#FFFFFF" class="STYLE19">
										<div align="center">${u.mail }</div>
									</td><td height="20" bgcolor="#FFFFFF" class="STYLE19">
										<div align="center">${u.activation_code }</div>
									</td>
									<td height="20" bgcolor="#FFFFFF">
										<div align="center" class="STYLE21">
											<a href="#" title="点击发布文章">发布</a> |
											<a href="DeleteUserServlet?id=${u.username}" title="点击删除用户">删除</a> |
											<a href="OpenUpdateUserServlet?id=${u.username}" title="点击编辑用户信息">编辑</a>
										</div>
									</td>
								</tr>
							</c:forEach>
			...
			<tr>
				<td height="30">
					<pg:pager url="SearchUserServlet" items="${total}" maxPageItems="${pagesize}" maxIndexPages="15" export="currentPageNumber=pageNumber">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td width="33%">
